...
4. Choose the `main` branch and `/ (root)` folder (or `/Site-main` if deployed from subfolder).
5. Click **Save**. Your site will be live at `https://<your-username>.github.io/<repo-name>/`.

### Deploying to Vercel
1. Import your GitHub repository on [Vercel](https://vercel.com).
2. Set Root Directory to `./` (or `Site-main`).
3. Click **Deploy**.

### Deploying to Netlify
1. Drag and drop the project folder into [Netlify Drop](https://app.netlify.com/drop) or connect your GitHub repository.
2. Set publish directory to `./` (or `Site-main`).
3. Click **Deploy Site**.
